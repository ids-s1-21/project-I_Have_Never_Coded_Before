...
```{r include=FALSE}
style_xaringan(
  title_slide_background_image = "img/opening.jpg"
)
```
...
middle_eastern <- police_time_race %>%
  filter(race == "Middle Eastern")

ggplot() + 
  geom_col(middle_eastern, mapping = aes(x = year, y = n)) + 
  labs( x = "Year", y = "Number of Deaths", title = "Police Deaths by Race", 
        subtitle = "Taking a closer look at just Middle Eastern") + scale_x_discrete(guide = guide_axis(angle = 45)) +
  theme(legend.position = "none")
