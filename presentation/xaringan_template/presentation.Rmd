...
=======
>>>>>>> 8683f6d6b0d2442181d9985d352f4442afc5573e
...
```{r adding_new_columns, inlcude = FALSE}
...
ggplot(police_zip,
  ...
  labs(x = "Year",
       ...
       subtitle = "Over Time") + scale_x_discrete(guide = guide_axis(angle = 45), breaks = seq(2000:2019))
```
---
